...
fp_benthic <- '02_Benthic/annual-report/Data/2021 benthic annual report data_20220820.xlsx'
```
...
# read in data
wkbk_raw <- read_excel(fp_benthic)

# create workbook for new data
wkbk_export <- createWorkbook()

# append raw data to new xlsx
add_sheet(wkbk_export, wkbk_raw, getSheetNames(wkbk_raw))
