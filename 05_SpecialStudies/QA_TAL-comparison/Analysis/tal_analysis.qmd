...
We note, however, that one Chl_RFU observation was an extreme outlier. It was excluded from the primary analysis to avoid undue influence on comparisons within the parameter.
...
There was no clear association between temperature and percent error for any parameter. Temperature is therefore not included in subsequent analyses.
...
There was no clear association between expected value and either the magnitude or variability of percent error.
