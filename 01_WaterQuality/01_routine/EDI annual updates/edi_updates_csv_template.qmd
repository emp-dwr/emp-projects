...
#code to import
getwd()
df_year_og <- read.csv("c:/Users/mpagliar/OneDrive - California Department of Water Resources/Documents/Github/emp-projects/AQS-observations-2025.csv")
View(df_year_og)
...
# Code to format dataset for EDI (function)
   ...
   df <- df %>%
    mutate(
      Lab..Detection.Condition = case_when(
        is.na(Lab..Detection.Condition) ~ 'Detected',
        TRUE ~ 'Not detected'
      )
    )
