...
df_edi <- df_test2 %>%
  select(`Location ID`, `Observed DateTime`, `Observed Property ID`, `Result Value`, `Result Unit`, `Lab: Detection Condition`, `Lab: MDL`, `Lab: MRL`, `EA_Reports To`, `Lab: Analysis Method`, `Lab: Quality Flag`, `EA_Field Quality Flag`, `Field: Comment`)
...
```{r}
write_csv(df_edi, 'C:/Users/sperry/Desktop/edi_draft.csv', na = '')
```
