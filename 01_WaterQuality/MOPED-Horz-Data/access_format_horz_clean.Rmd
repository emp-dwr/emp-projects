...
fp_all_wq <- archive_path(2017, 'MOPED')
...
for(i in 1:nrow(df_combo)){
  ...
  df_wq <- read_csv(fp_wq, show_col_types = FALSE)
  df_wq1 <- read_csv(fp_wq, show_col_types = FALSE)
...
#write_csv(df_month, 'C:/Users/cstuart/Desktop/Annual Moped Files - Temp/MOPED_2020_combined.csv')
```
