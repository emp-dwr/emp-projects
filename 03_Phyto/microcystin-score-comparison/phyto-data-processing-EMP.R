...
phyto_files_EMP <- dir(path = "data/EMP_phyto/csv", pattern = "\\.csv", full.names = T)

df_phyto_EMP <- map_dfr(phyto_files_EMP, ~read_csv(.x))

# Read in files with non-standard headers individually
df_Dec2021 <- read_csv("data/EMP_phyto/oddballs/December 2021.csv")
df_Nov2021 <- read_csv("data/EMP_phyto/oddballs/November 2021.csv")
df_Sep2013 <- read_csv("data/EMP_phyto/oddballs/September 2013.csv")
df_Nov2013 <- read_csv("data/EMP_phyto/oddballs/November 2013.csv")
...
save(df_phyto, file = "df_EMP_phyto.RData")
